        ...
        <q-page class="flex flex-center">
                ...
                <div class="container">
                    ...
                    <div>
                        ...
                        <div style="display: -webkit-box;">
                            <q-input v-model="psw" no-pass-toggle="false"
                            class="login_input login shadow-1 pass" 
                            :type="isPassword ? 'password' : 'text'" 
                            style="width: 100%;"
                            placeholder="Contraseña" hide-underline />
                            <div  style="position: absolute;right: 20%;margin-top: 5px; z-index: 2;">
                                <q-btn 
                                    flat 
                                    round
                                    :icon="isPassword ? 'visibility' : 'visibility_off'"
                                    @click="changeTypePass"
                                    :color="isPassword ? 'grey-7' : 'primary'" />
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <input  v-model="name"
                                ...
                                type="text"
                                :placeholder="'Nombre' + (isIOS ? '*':'')"/>
                    </div>
                        <div class="col-xs-6">
                            <input v-model="lastName"
                               :class="errorLastName? 'login_input login shadow-1 radius_xs mora1':'login_input-newaccount login shadow-1 radius_xs mora2'"
                               type="text"
                               :placeholder="'Apellido' + (isIOS ? '*':'')"/>
                    </div>
                    
                </div>


                    <div class="col-xs-6 prueba">
                        <q-select v-model="select_tipo_documento" :class="errorSelect_tipo_documento? 'login_input login shadow-1 radius_xs mora1 ':'login_input-newaccount login shadow-1 radius_xs mora2'" :options="list_tipo_documento" placeholder="Seleccione tipo Documento*"/>
                    </div>   
                       ...
                       :placeholder="'NRO. DNI / RUC / C.E / PAS'+ (isIOS ? '*':'') "/>
                        ...
                        <q-input v-model="email" :class="errorEmail? 'login_input login shadow-1 radius_xs mora1':'login_input-newaccount login shadow-1 radius_xs mora2'" type="email" :placeholder="'Email' + (isIOS ? '*':'')" hide-underline />
                        ...
                        <br/>
                        <div v-if="isIOS" style="text-align: left;color: #6b6b6b !important;font-size:11px">* Estos campos son obligatorios</div>
            ...
            <q-modal v-model="popup_condiciones" maximized :content-css="{padding:'20px'}">
                ...
                <div class="text-justify">
                    <div class="column">
                        <div v-html="$formatDatosGenerales('politicas-condiciones',datos_generales)" />
            ...
            <q-modal v-model="popup_politicas" maximized :content-css="{padding:'20px'}">
                ...
                <div class="text-justify containerPopup">
                    <div v-html="$formatDatosGenerales('autorizacion',datos_generales)" />
                    <!--div class="row">
    ...
    <q-layout-footer v-if="show_form_login" class="border-footer">
        <q-item @click.native="show('register')">
            <q-item-main style="margin: auto;" class="text-center login_texto">
                <label>¿No estás registrado?</label><br><label style="color:red"><b>Regístrate aquí</b></label>
            </q-item-main>
        </q-item>
    </q-layout-footer>
</q-layout>
