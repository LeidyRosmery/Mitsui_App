    ...
    <div>
        ...
        <q-modal v-model="popup_vehiculo" maximized :content-css="{padding:'20px 20px 100px 20px',}">
            <div class="row">
                ...
                <!--GNM+{ -->
                <div class="col-2">
                    <button @click="filtrar_autos_placa" id="idBtnFiltro" class="q-btn inline relative-position q-btn-item non-selectable btnAdd q-btn-rectangle q-focusable q-hoverable bg-primary text-white" style="padding-left: 18px;padding-bottom: 1px;padding-top: 1px;padding-right: 18px;">
            
            <div class="q-focus-helper"></div>
            
            <div class="q-btn-inner row col items-center justify-center">
            
            <i aria-hidden="true" class="q-icon icono">
            
            <img src = "../../../statics/images/setting.svg" class="house">
            ...
            <!-- <q-card v-for="item in filteredItems" :key="item.zPlaca" class="shadow-8 cardVehiculo"> -->
            <q-card v-for="item in filteredItems" :key="item.zPlaca" class="shadow-8 cardVehiculo">
                <q-card-main>
                    <div class="row">
                        <div class="col-xs-3">
        ...
        <!--Modal Filtro behiculos-->
        <q-modal @show="$bodyFixed" @hide="$bodyBlock" v-model="popup_filtro_autos" minimized content-css="border-radius:8px;">
            <div>
            ...
            <img src = "../../../statics/images/back.svg" class="house" style="padding-top: 0px;padding-left: 0px;padding-bottom: 10px;width: 40px;" @click="clear_autos_placa">
            
            </i>
                </div>
                <div class="popup_title margen-from-title text-bold text-center" style="margin-bottom: 15px !important;">
                    BUSCAR PLACA</div>
            </div>
            <div class="row">
                <div class="row-date-register" style="
            ...
            ">
                    ...
                    <!-- <a id="id_btn_cerrar" color="primary" class="btn-search" @click="onpressBuscar" label="Buscar">Buscar</a>
                            
                            <a id="id_btn_ok" class="btn-limpiar" color="primary" @click="clear_autos_placa" label="Limpiar">Limpiar</a> -->
                    <a><button id="id_btn_cerrar" color="primary" class="btn-search" @click="onpressBuscar">Buscar</button></a>
                    <a><button id="id_btn_ok" class="btn-limpiar" color="primary" @click="clear_autos_placa">Limpiar</button></a>
                </div>
            </div>
        </q-modal>
        <!--CitaPendiente-->
        ...
        <!--NuevoAuto-->
        <q-modal :style="'top:auto !important;min-height:' + $deviceSize.heigth +'px !important;'" v-model="popup_newAuto" @show="$bodyFixed" @hide="$bodyBlock" position="bottom">
            ...
            <div class="containerNew">
                ...
                <div class="row">
                    <div class="row-date-register">
                        <div class="q-if row no-wrap items-end relative-position q-input shadow-1 radius_xs q-if-hide-underline text-primary">
                            <div class="q-if-inner col row no-wrap relative-position">
                                <input @input="keyPressPlaca" @blur="blurPlaca" maxlength="7" placeholder="PLACA" v-model="placa_seleccion" class="col q-input-target q-no-input-spinner">
                            </div>
                        </div>
                    </div>
                    <div class="row-date-register">
        ...
        <!--Servicios-->
        <q-modal :style="'min-height:' + $deviceSize.heigth +'px !important;position: fixed'" v-model="popup_servicio" maximized>
            <div class="flex-row-docs page-servicio">
                ...
                <div class="doc-container">
                    ...
                    <div tabindex="-1" class="q-if row no-wrap items-end relative-position q-input obs-servicio text-primary" maxlength="256">
                        <div class="q-if-inner col row no-wrap relative-position">
                            <input maxlength="256" type="text" placeholder="OBSERVACIÓN (Opcional)" v-model="observacion_seleccion_2" step="any" class="col q-input-target q-no-input-spinner">
                        </div>
                    </div>
